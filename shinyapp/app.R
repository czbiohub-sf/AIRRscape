...
ui <- fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      p("To run AIRRscape locally and for more detailed instructions, AIRRscape is available on GitHub at"),
      HTML("https://github.com/czbiohub/AIRRscape"),
      p("The AIRRscape publication is on bioRxiv at"),
      HTML("https://doi.org/10.1101/2022.03.24.485594"),
